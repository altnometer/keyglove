...
indx2_switch_center = (tocm(0.75), tocm(0.5), tocm(0))
...
# switch center
mdl0_switch_center = (tocm(1.25), tocm(0), tocm(0))
...
# switch center will be transformed by these distances from base center
ring2_switch_center = (tocm(0), tocm(2.75), tocm(0))
...
pinky0_surf_mdl = pinky0_surf_low + tocm(15)
pinky0_surf_high = pinky0_surf_low + tocm(15)
