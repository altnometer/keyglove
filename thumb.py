...
#                               _______/                     / |
#                              /      /                     /  |
#                      _______/      /_____________________/   | hight
#                     /      /       |                     |   |
#             _______/      /________|                     |   |
#            /      /       |        |                     |   |
#   length  /      /________|        |    base             |   /
#          /       |        | inner  |                     |  /
#         /________| middle |        |                     | /
...
inner_segment_width = tocm(16)
base_segment_width = tocm(98)
base0_length = tocm(58)
adjust_xcoord_for_base = tocm(9)
# increase to move toward the finger section
adjust_ycoord_for_base = tocm(26.5) - (base0_length / 2)
...
inner0_hight = THUMB_SECTION_HIGHT + tocm(30)
...
inner0_body_rotation_angle_deg = 0
...
# adjust this value to move inner0 segment along xcoord, greater values move the segment to the left
inner0_adjust_xcoord_segment_position = tocm(-4)
# adjust xcoord to move thumb section relative
...
inner0_ycoord_adjust = tocm(0) + adjust_ycoord_relative_to_fingers_section
...
# any segment width change may displace the original xcoord, adjust for this
# with this setting.
outer0_adjust_xcoord_for_width_change = tocm(2)
